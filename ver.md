...
### 1.3.2-alfa05 (2026/01/16)         
  
- alfa03->alfa05 update表示エラーを修正しました。  
  alfa02->alfa03 らじる（放送局）がエラーになっていたのを修正しました。  
  alfa01->alfa02 ソースの整理
  動作がおかしい場合は、旧バージョンに戻してください。  
  掲示板のほうに報告していただくと助かります。  
  
### 1.3.2-alfa01 (2026/01/11)         
