...
初期公開はamazon fire限定になります。  
他のスマートフォンでも動作する可能性はありますが。  
    
### 1.2 Amazon Fireの世代確認
...
amazon fire Fire OS 6,7,8 (ただし、arm)であればOKです。  
aarch64タイプは当面適用外です。 
...
[termuximg.sh](https://raw.githubusercontent.com/rfriends/rfriends_termux/main/termuximg.sh)    
...
2026/05/20現在、各機種の世代に従って以下をダウンロードし、インストールしてください。  
https://github.com/termux/termux-app/releases  
  
1) Fire OS 5 (Android 5.1) arm  
Fire 7     第7世代 (2017)  
Fire HD 8  第7世代  
Fire HD 10 第7世代  
...
2) Fire OS 6 (Android 7.1), Fire OS 7 (Android 9.0) arm  
Fire 7     第9世代 (2019)  
Fire HD 8  第8世代 (2018)  
Fire HD 8  第10世代 (2020)  
Fire HD 10 第9世代 (2019)  
  
termux-app_v0.119.0-beta.3+apt-android-7-github-debug_armeabi-v7a.apk  
  
3) Fire OS 8 (Android 11) arm  
これらの機種ではexec制限のため、うまく動作しないかもしれません。  
当方に環境がないので確認できません。    
Fire 7     第12世代 (2022)	  
Fire HD 8  第12世代 (2022)	  
...
2) androidのダウンロードディレクトリにアクセスし、termuximg.shがあることを確認します。  
