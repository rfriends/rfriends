...
|確認日付|ディストロ|バージョン|ステータス|   
|---|---|---|---|  
|2025/04/19|Ubuntu|22.04,24.04|〇|  
|2025/04/19|Debian|11|〇|  
|2025/04/19|ZORIN OS||〇|  
|2025/01/24|Chromeos linux開発||flexもOK(〇)|   
...
|確認日付|ディストロ|バージョン|ステータス|    
|---|---|---|---|  
|2025/04/20|CentOS stream||〇|  
|2025/04/20|Rocky linux||〇|  
|2025/04/20|Alma linux||〇|  
|2025/04/20|Oracle linux||〇|   
|2025/04/20|Miracle linux|9.4|〇|  
|2025/04/19|fedora linux|42|検証中|  
  
### 1.3 BSD系  (install_freebsd.sh)

|確認日付|ディストロ|バージョン|ステータス|   
|---|---|---|---|  
|2025/04/20|FreeBSD||samba419を選択(〇)| 
  
### 1.4 その他  

|確認日付|ディストロ|バージョン|ステータス|   
|---|---|---|---|  
|2025/04/20|Alpine||install_alpine.sh(〇)|  
|2025/04/15|Arch linux||install_arch.sh (検証中)|   
|2025/04/15|openSUSE|15.6|install_suse.sh (検証中)|  
