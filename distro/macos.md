...
> [!CAUTION]  
> 現在、マック版では、jcba,fm++で局により音切れが発生することがあります。     
  
第4版　2025/01/08 sequoia  
第5版　2025/09/25 chromium  
第6版　2026/03/05 brew 
第7版　2026/07/25 記述修正  
第8版　2026/08/09 lighttpd追加 
...
> [!NOTE]  
> シリコンMACでも動作するようにしました。  
> 動作した、しないの一言でもいいので、掲示板等にコメントいただければ幸いです。  
  
・ビルトインウェブサーバーを動作させているターミナルでctrl+cを入力し、停止させる。  
