...
#### 3.2.1 ダウンロードディレクトリにあるtermux.shを実行する。    
...
#### 3.2.6 次にexitを入力して、termuxを一旦終了してください。  
